...
```
```{r}
# Analyses of crop type based simulations 

data_crops <- read.csv("C:/Users/imket/Documents/GitHub/European_hamster_GMSE/Output/croptypes_4x1_4x2_2x3_100it_30startN_simulation2.csv", header=TRUE,sep=",")
...
plot_crops<-generate_plot(data_crops, "N30, 2 type 3, 4 type 1 and 2")
