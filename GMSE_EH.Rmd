...
#parameters specified below are for hamsters in crop type 3, except for the extra litter which is currently modelled by the function crop_hamster_2. ! For types 1 and 2, a different mortality is modelled each month. 
